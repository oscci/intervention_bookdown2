...
```{r n-of-1-logic,echo=F,include=T,tab.caption= "How intervention vs control is allocated in different study designs"}
Design <- c('RCT','N-of-1: ABA','N-of-1: Multiple baseline across behaviours')
Participants <- c('+','-','-')
Time <- c('-','+','-')
Outcome <- c('-','-','+')
