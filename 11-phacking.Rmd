...
```{r confusionMat2a, echo=FALSE, message=FALSE, warnings=FALSE,results='asis',tab.cap="Possible outcomes of Null Hypothesis Statistical Test"}
...
#The next chunk is very slow - about 30 mins - to run. The results file with the columns added from this step is now save ond drive, and can therefore be read in (has _plus suffix). 
