...
```{r prismachart, echo=F,fig.align="center", fig.cap="PRISMA flowchart from @dipper2020"}
...
At this stage the methodology of each study is scrutinised to see whether it meets predefined quality criteria. Some  studies may be excluded at this stage; for others, a rating is made of quality so that higher weighting can be given to those with high quality. Statistical power typically is a major factor in quality ratings, as null results from underpowered studies are not very informative (see Chapter \@ref(power)). 
