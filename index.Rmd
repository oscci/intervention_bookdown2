--- 
title: "Evaluating and conducting intervention studies in allied health professions"
...
One of the good things about an online book is that it can remain a work in progress for some time, giving readers the opportunity to provide suggestions and corrections. We welcome such feedback. Readers who already use github can of course send pull requests with suggestions for changes, but we anticipate that most readers won't be familiar with this approach, and we encourage them to ??? make suggestions on a google doc?!!
