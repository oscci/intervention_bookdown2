...
documentclass: book
bibliography: [book.bib, packages.bib,DB_biblio.bib]
...
<!---h4 command above is attempt to get the custom chunks to have centred headings, but it did not work.-->
...
The inspiration for the book came from interactions with speech and language therapists, and the illustrative cases are from that discipline, but the basic principles covered here are relevant for any field where a practitioner aims to influence outcomes of those they work with. This includes professions allied to medicine and education.
