...
knitr::include_graphics("images/adaptive_designs.png")
``` 
...
The Nahum-Shani is a v useful introduction, but I do worry that this approach does just divide people into 'responders' and 'nonresponders' in exactly the way we argued against in chapter 1! - ie assuming measurs are perfectly reliable and so can be validly used to subdivide cases.
