...
Table \@ref(tab:step13) is reproduced from @Porzsolt_2015, who describe the 13 steps to assessing efficacy and effectiveness.
...
```{r step13,echo=FALSE,message=FALSE,warning=FALSE,tab.caption="Thirteen steps to assess efficacy (explanatory trial) and effectiveness (pragmatic trial)"}
library(tidyverse)
library(knitr)
#library(kableExtra)
library(flextable)
