...
```{r packages3, echo=F, message=F, warning=F, fig.width=8,fig.height=4}
...
## Reliability
```{r darts, echo=F, fig.cap='Reliability and validity illustrated as darts hitting a target'}
...
```{r MLU-plot,echo=TRUE,warning=TRUE,message=TRUE,fig.cap='Mean length of utterance (MLU) values for a cohort of 630 children speaking North American English in the Child Language Data Exchange System archive. Recreated from Ratner & MacWhinney, 2016 (data kindly provided by authors'}
